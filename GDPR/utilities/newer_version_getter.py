...
# This program uses Bing Search API get the URLs linked to the companies' current privacy policy.
# It generates a file with all URLs collected
from pws import Bing # Bing Search API; install it by open terminal and enter
